---
# heading of document
title: 符号记忆（symbolMemory） # Chinese name（English name）
author: 张亮
date: 2018-07-31 # format 2006-01-01
# slug
slug: 05401-symbolMemory # code-English name
...
* **英文名称**：`r NAME_EN`
* **题目编号**：`r CODE`
* **任务描述**：测查记忆力，特别是个体记住各种符号的能力。
* **测查能力**：记忆力-语义记忆
* **相关任务**：[图片记忆](`r blogdown::shortcode("relref", "03501_pictureMemory.html")`)。
